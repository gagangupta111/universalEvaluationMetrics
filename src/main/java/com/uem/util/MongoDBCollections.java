...
public class MongoDBCollections {
    ...
    public static List<Document> getAllTestObjects(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getTest();
            filter = BsonDocument
                    .parse("{ " + "}");
    ...
    public static List<Document> getAllBatch(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getBatch();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
    ...
    public static List<Document> getAllCourse(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getCourse();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
    ...
    public static List<Document> getAllCourseAdmin(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getCourseAdmin();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
    ...
    public static List<Document> getAllPermissions(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getPermissions();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
    ...
    public static List<Document> getAllStudents(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getStudent();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
    ...
    public static List<Document> getAllTeachers(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getTeacher();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
    ...
    public static List<Document> getAllUniversity(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getUniversity();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
    ...
    public static List<Document> getAllUniversityAdmin(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getUnivAdmin();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
    ...
    public static List<Document> getAllUniversalUsers(BsonDocument filter ) {
        ...
        try {
            MongoCollection<Document> collection = MongoDBCollections.getUniversalUser();
            filter = BsonDocument
                    .parse("{ " + "}");
            List<Document> allDocuments = collection.find(filter).into(new ArrayList<Document>());
            return allDocuments;
